...
const featuredProjectInfo: ProjectCard = {
  ...
  description: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione, doloremque? Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione, doloremque? Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione, doloremque?",
  logo: projectoLogo,
      ...
      <div className="project-card">
        <div className="project-card__icons-container">
          ...
          <div className="project-card__icons">
            {featuredProjectInfo.technologies.map((tech, index) => (
              <CustomIcon key={index} color="#FAFAFA">{tech}</CustomIcon>
            ))}
          </div>
        </div>
        ...
        <div className="project-card__content">
          <div className="project-card__text">
            <h3 className="project-card__text-title">{featuredProjectInfo.title}</h3>
            <p className="project-card__text-description">
              {featuredProjectInfo.description}
            </p>
            <a href={featuredProjectInfo.liveLink} target="_blank" className="project-card__text-link">
              Watch it live!
            </a>
          </div>
